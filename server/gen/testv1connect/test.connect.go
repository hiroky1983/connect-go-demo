...
type TestServiceClient interface {
	Test(context.Context, *connect.Request[server.TestRequest]) (*connect.Response[server.TestResponse], error)
}
...
func NewTestServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) TestServiceClient {
	...
	return &testServiceClient{
		test: connect.NewClient[server.TestRequest, server.TestResponse](
			httpClient,
...
type testServiceClient struct {
	test *connect.Client[server.TestRequest, server.TestResponse]
}

// Test calls test.v1.TestService.Test.
func (c *testServiceClient) Test(ctx context.Context, req *connect.Request[server.TestRequest]) (*connect.Response[server.TestResponse], error) {
...
func (UnimplementedTestServiceHandler) Test(context.Context, *connect.Request[server.TestRequest]) (*connect.Response[server.TestResponse], error) {
